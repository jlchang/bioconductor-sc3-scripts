...
SingleCellExperiment <- sc3_prepare(SingleCellExperiment, gene_filter = opt$gene_filter, pct_dropout_min = opt$pct_dropout_min, pct_dropout_max = opt$pct_dropout_max, d_region_min = opt$d_region_min,
  d_region_max = opt$d_region_max, svm_num_cells = opt$svm_num_cells, svm_train_inds = svm_train_inds, svm_max = opt$svm_max, n_cores = opt$n_cores , kmeans_nstart = opt$kmeans_nstart,
  kmeans_iter_max = opt$kmeans_iter_max, rand_seed = opt$rand_seed)
